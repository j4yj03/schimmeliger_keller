...
\begin{columns}
 \column{0.1\textwidth}
\begin{figure}
\includegraphics[scale=0.2]{bilder/Sensor_Read_and_LoRa_Send}
\end{figure}
\column{0.3\textwidth}
\begin{figure}
 \includegraphics[scale=0.2]{bilder/LoRa_Read}
\end{figure}
\end{columns}
\end{frame}
...
\begin{columns}
 \column{0.1\textwidth}
\begin{figure}
\includegraphics[scale=0.2]{bilder/MQTT_publisher}
\end{figure}
\column{0.3\textwidth}
\begin{figure}
 \includegraphics[scale=0.25]{bilder/MQTT_subscriber}
\end{figure}
\end{columns}
\end{frame}
